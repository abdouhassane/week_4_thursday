...
```{r loading-data}
# Your code below:
data <- read_tsv("data/madrid_pollution.tsv")
```
...
the EBE conc seems to be cycling over time, and potentially decreasing but difficult to tell because cant resolve density 
...
```{r pollution_diff}
# Your code below:
a <- pollution_2006 - pollution_2001 
